function [D,L] = dgmflowdistance(InGrid,M,X,Y,dem,ix)

% compute flow distance through a certain area defined by a binary grid
% to cell or to catchment outlet
% 
% Syntax
%
...
% Input
%
%     InGrid  binary grid defining the region through which flow path
%             length should be counted
